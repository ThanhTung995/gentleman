...
<ul
	class="cart_list product_list_widget border--bottom <?php echo isset( $args['list_class'] ) ? esc_attr( $args['list_class'] ) : ''; ?>">
	...
	<?php else : ?>
		...
		<li class="empty">
			...
			<?php pure_woocommerce_continue_shopping_button(); ?>
		</li>
	<?php endif; ?>
