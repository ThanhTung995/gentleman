...
<?php } else { ?>
	...
	<p class="meta">
		...
		?><span class="woocommerce-review__dash">&ndash;</span> <time class="woocommerce-review__published-date" datetime="<?php echo get_comment_date( 'c' ); ?>" itemprop="datePublished"><?php echo get_comment_date( wc_date_format() ); ?></time>
	</p>
